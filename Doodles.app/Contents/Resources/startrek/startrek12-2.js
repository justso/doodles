(function () {
    ...
    j.F = function () {
        ...
        a.width = "375px";
        a.height = "220px";
        a.background = "url(./startrek12-hp.jpg) 0 " + this.fe + "px no-repeat";
        V(this.d, b, 0, 0);
        this.ic();
        b = x();
        a = b.style;
    ...
    Y.prototype.mf = function () {
        ...
        this.va = x();
        var a = this.va.style;
        a.background = "url(./startrek12-hp.jpg) 0 " + this.ze + "px no-repeat";
        a.width = "375px";
        a.height = "220px";
        a.zIndex = 10;
    ...
    var eb = function (a, b, c, e) {
        ...
        this.i = 1500;
        this.Ce = 1E3;
        this.fc = "./startrek12-transport.png";
    ...
    var kb = function (a, b, c, e) {
        ...
        this.G = x();
        a = this.G.style;
        a.background = "url(./startrek12-transition.png) repeat-y 0 0";
        a.zIndex = 90;
        a.height = "220px";
        a.display = "none";
        a.width = "1534px";
    ...
    Z = g,
    $ = g,
    tb = new u("./startrek12-hp-bridge.png", [[767, 149, 10, 9], [965, 552, 10, 9], [176, 456, 22, 18], [663, 447, 22, 18], [1010, 281, 22, 18], [0, 0, 22, 18], [511, 447, 22, 18], [0, 42, 22, 18], [285, 340, 22, 18], [865, 716, 22, 18], [812, 356, 22, 18], [1013, 40, 22, 18], [938, 239, 22, 18], [865, 588, 22, 18], [176, 376, 22, 18], [938, 260, 22, 18], [938, 281, 22, 18], [0, 523, 22, 18], [123, 672, 22, 18], [418, 447, 22, 18], [812, 335, 22, 18], [840, 377, 22, 18], [396, 589, 22, 18], [789, 0, 22, 18], [151, 376, 22, 18], [0, 319, 22, 18], [0, 63, 22, 18], [310, 340, 22,
    ...
    ub = new u("./startrek12-hp-transporter.png", [[438, 219, 62, 60], [279, 73, 65, 71], [1416, 0, 63, 69], [405, 0, 47,
    ...
    vb = new u("./startrek12-hp-anim.png", [[0, 26624, 118, 72], [0, 4743, 118, 72], [0, 18728, 118, 72], [242, 8140, 118, 72], [0, 7912, 118,
    ...
    wb = new u("./startrek12-transition.png", g),
    xb = function () {
        if (J) {
            var a = J;
            a.o && a.o.qb()
